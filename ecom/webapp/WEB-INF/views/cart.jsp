    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm bg-color transparent">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
              ...
              <li class="nav-item">
                    <a class="nav-link link text-secondary display-4" href="payment">checkout</a>
                </li>
...
<c:forEach items="${cartList}" var="cart">
	...
	<td>${cart.productId}</td>
		...
		<td>${cart.productDesc}</td>
			<td>   
        <img alt="logo" src="resources/images/${cart.productId}.jpg"style="height: 100px; width: 30%" /> 
  		</td>
			<td>
...
<center><h1><a href="userproducts">Continue shopping</a></h1></center>
